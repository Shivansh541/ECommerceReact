...
const Order = (props) => {
    ...
    const handleSubmit = async () => {
        ...
        prodView.current.style.display = 'none'
    ...
    return (
        <section className="orderBox">
            <div ref={prodView} className="cart show">
                <h1>Order Summary</h1>
                {Object.keys(props.products).map((productId) => {
                    const product = props.products[productId].product;
                    return (
                        <div key={productId} className="box">
                            ...
                            <div className="col">
                                ...
                                <div className="buttons">
                                    <div className='qty'><button disabled={props.products[productId].qty === 1} onClick={() =>
                                        minusbtn()} className='btn'>-</button><span>{props.products[productId].qty}</span><button onClick={() => { plusbtn() }} className='btn'>+</button></div>
                                </div>
                            </div>
                        </div>
                    );
            ...
            <div ref={address} className='address'>
                <h1>Address</h1>
            ...
            <div ref={billref} className="bill show">
